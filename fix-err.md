...
1. 红方 `red_j20_patrol` 初始位置改为漳州机场，航向向东，设置 `speed 450 knots`，并绑定 `route red_patrol_route`。
2. 蓝方 `blue_f16v_patrol` 初始位置改为嘉义机场，航向向西，设置 `speed 450 knots`，并绑定 `route blue_patrol_route`。
